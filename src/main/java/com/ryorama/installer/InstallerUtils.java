package com.ryorama.installer;

import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import com.ryorama.modloader.RyoramaModloader;
...
public class InstallerUtils {
    ...
    public static String findMCDir(boolean isDev) {
        ...
        if (!isDev) {
            ...
            dir = RyoramaModloader.getDir()+ "\\run";
        }
        return dir;
    }
    ...
    public static File findVersionsDir() {
        File dir;
        dir = new File(findMCDir(RyoramaModloader.isDev) + File.separator + "versions");
        if (!dir.exists())
            dir.mkdirs();
        return dir;
    }
